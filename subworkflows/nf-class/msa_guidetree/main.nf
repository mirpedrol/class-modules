if ( params.guidetree == "clustalo/guidetree" ) {
    include { CLUSTALO_GUIDETREE as GUIDETREE } from '../../../modules/nf-class/clustalo/guidetree/main'
} else if ( params.guidetree == "famsa/guidetree" ) {
    include { FAMSA_GUIDETREE    as GUIDETREE } from '../../../modules/nf-class/famsa/guidetree/main'
} else if ( params.guidetree == "magus/guidetree" ) {
    include { MAGUS_GUIDETREE    as GUIDETREE } from '../../../modules/nf-class/magus/guidetree/main'
}
